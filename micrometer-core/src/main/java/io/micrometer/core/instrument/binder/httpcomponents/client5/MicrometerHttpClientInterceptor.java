 ...
 * configuring with an {@link org.apache.hc.client5.http.classic.HttpClient}. Usage example:
 * <pre>{@code
...
public class MicrometerHttpClientInterceptor {
    ...
    public MicrometerHttpClientInterceptor(MeterRegistry meterRegistry,
        ...
        this.requestInterceptor = (request, entityDetails, context) -> timerByHttpContext.put(context, Timer.resource(meterRegistry, METER_NAME)

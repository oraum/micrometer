...
class MicrometerHttpClientInterceptorTest {
    ...
    @Test
    void syncRequest(@WiremockResolver.Wiremock WireMockServer server) throws Exception {
    ...
    void uriIsReadFromHttpHeader(@WiremockResolver.Wiremock WireMockServer server) throws Exception {
        ...
        CloseableHttpClient client = client(interceptor);
        HttpGet request = new HttpGet(server.baseUrl());
    ...
    private CloseableHttpClient client(MicrometerHttpClientInterceptor interceptor) {
